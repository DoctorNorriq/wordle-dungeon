...
<template>
  <div
    class="column-flex gap-4 relative"
    :class="[
      wordGuessed ? 'pb-30' : '',
      runActive ? '' : 'h-full justify-center',
    ]"
  >
    <div v-if="!signingOut">
      <div v-if="runActive">
        <div class="text-center">
          <div class="flex items-center gap-2 justify-center flex-wrap">
            <h1 class="text-brand-yellow">
              <span class="wordle text-brand-white"
                ><span
                  class="wordle text-brand-white"
                  @click="toggleWordVisibility"
                  >W</span
                >ordle</span
              >
              Dungeo<span @dblclick="handleGenerateWords">n</span>
            </h1>
            <UTooltip
              :delay-duration="0"
              :content="{
          ...
          >
            Words:
            <p v-for="word in words" :key="word" class="text-brand-yellow">
              {{ word }}
            </p>
          </div>
        </div>
      ...
      <div v-else class="w-full column-flex">
        ...
        <section v-if="editingUser" class="max-w-[600px] column-flex w-full">
          ...
          >
            ...
            <UFormField label="Self Description">
              <UTextarea
          ...
          <form v-else class="w-full" @submit.prevent="updatePassword">
            <UInput
              v-model="password"
              variant="outline"
              color="primary"
